            ...
            <Box variant="articleDetail">
                ...
                <Box variant="articleCommentsListContainer">
                    <Box variant="commentPDP">
                        {article.comments.map((comment: { memberInfo: { imageUrl: any; nickname: any; }; createdAt: string | number | Date; content: any; id: number; }, index: React.Key | null | undefined) => (
                ...
                <div className="flex justify-end space-x-2 mt-2">
                    <Button color="red" onClick={() => handleArticleDelete(articleId)}>게시글 삭제</Button>
                </div>
            </Box>
        </PageContainer>
    );
