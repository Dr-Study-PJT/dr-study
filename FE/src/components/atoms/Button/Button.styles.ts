...
export const buttonStyles = tv({
    ...
    variants: {
        variant: {
            home: 'w-[196px] h-[53px] bg-gray-500 hover:bg-gray-700 text-white text-lg rounded-[32px] py-2 px-6',
            checkAndTry:
                'w-[196px] h-[53px] bg-[#8D251A] hover:bg-[#6b1b14] text-white text-lg rounded-[32px] py-2 px-6',
            // 7번 줄의 home의 style 버튼과 동일함.
            something:
